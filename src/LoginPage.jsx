...
export default function LoginPage() {
    ...
    const startOAuth = async (provider) => {
        const { error } = await supabase.auth.signInWithOAuth({
            ...
            options: {
                redirectTo: window.location.origin, // sends user back to your app after login
            },
        });
                ...
                <section className="hero">
                    <div className="hero-card">
                        ...
                        <p className="hero-copy">
                            This page is a UI shell so someone can implement
                            OAuth in the backend next.
                        </p>
                        ...
                        <form className="login-form" onSubmit={onSubmit}>
                            ...
                            <div className="muted" style={{ fontSize: 13 }}>
                                Backend note: wire OAuth providers to{" "}
                                <code>
                        ...
                        <div className="mock phone">
                            ...
                            <div className="phone-body">
                                ...
                                <div className="mini-card">
                                    ...
                                    <div className="mini-card-meta">
                                        Drag recipes into your week
                                    </div>
                                </div>
                                <div className="mini-hint">
                                    OAuth backend implementation next
                                </div>
                            </div>
                        </div>
                    </div>
